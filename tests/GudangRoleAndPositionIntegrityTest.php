...
runTest('EmployeeImportHandler memvalidasi dan memproses baris posisi "gudang" tanpa error', function() use ($pdo) {
    ...
    $rows = [
        ['3201999988887703', 'TEST Karyawan Gudang Impor', 'gudang', 'bulanan', 2750000, 20000, 150000, '081299887766', '', 'Gudang Pusat', '2024-03-01', 'Mandiri', '1234567890', 'TEST Karyawan Gudang Impor', 'Aktif']
    ];
