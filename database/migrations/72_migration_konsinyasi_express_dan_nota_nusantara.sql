-- ============================================================================
-- Migrasi 72: Konsinyasi Express Single-Screen & Standarisasi Nota Nusantara
-- 1. Dukungan Tambah Titip Baru (Kiriman Hari Ini) pada fn_proses_kunjungan_konsinyasi
-- 2. Pembaruan Saldo Rak: Stok Rak Baru = Sisa Fisik di Rak + Tambah Titip Baru
-- 3. Pengurangan Stok Fisik Gudang / Muatan Sales & Pencatatan Kartu/Riwayat Stok
-- 4. Dukungan Atomic Transaction Sesuai Protokol AGENTS.md
-- ============================================================================
