-- database/14_fix_triggers_pasca_merge.sql
-- Perbaikan triggers yang masih mereferensikan kolom karyawan_id di tabel pengguna
-- Dibuat: 2026-09-10

-- 1. Perbaiki fn_guard_developer_account (Hapus referensi NEW.karyawan_id)
...
-- 2. Fungsi fn_proses_kunjungan_konsinyasi di db (jika masih versi lama, ini menimpanya dengan yang baru dari migration 12)
