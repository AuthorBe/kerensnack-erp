...
CREATE TABLE IF NOT EXISTS public.pesanan (
    ...
    tipe_pembayaran VARCHAR(30) NOT NULL CHECK (tipe_pembayaran IN ('cash', 'qris', 'transfer', 'konsinyasi', 'sebagian', 'tempo_tanggal', 'tempo_faktur')),
    ...
    is_tagihan BOOLEAN NOT NULL DEFAULT TRUE,
